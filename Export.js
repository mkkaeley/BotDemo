...
module.exports = {
    ...
    on_variable_update: function(requestId, data, callback) {
        ...
        const { exec } = require('child_process');
           exec('java -cp "C:\\Users\\sjvfn\\AppData\\Roaming\\Code\\User\\workspaceStorage\\f7ed9e7cc546d4d4f9d5622fcdd27ac8\\redhat.java\\jdt_ws\\Botkit-Master-Demo-main_718da605\\bin;c:\\Users\\sjvfn\\Downloads\\Meenakshi\\Botkit-Master-Demo-main\\lib\\json-20230618.jar" ExportJava', (error, stdout, stderr) => {
          if (error) {
